...
Важное замечяние! В брифе от заказчика не верно прописаны условия в пункте 2 ii; iii. Описание подсветки полей ввода данных не вернoe. Но разработчик исправил ошибку.

Автоматизированное тестирование страницы https://b2c.passport.rt.ru сайта "Ростелеком"

При тестировании сайта были написаны:https://drive.google.com/drive/folders/1jngqNjmaEEc6PpC9WN4aHp2lFPwzIiax?usp=drive_link 
